<section id="lista">
    ...
    <!--INCLUIR E PESQUISA-->
    <div class="operacoes">
        <!--<a href="<?php echo url::base() ?>contatos/edit" class="btn-inserir">Novo</a>-->
                ...
                <div class="box-body">
                    <table class="table table-bordered">
                      ...
                      <tr>
                          ...
                          <th>Telefone
                              <span><a href="#" onclick="ordenar('CON_TELEFONE', 'asc')" class="seta-acima"></a>
                                  <a href="#" onclick="ordenar('CON_TELEFONE', 'desc')" class="seta-abaixo"></a></span>
                          </th>
                          <th>Data
                      ...
                      if (count($contatos) > 0) {
                          foreach($contatos as $con){
                              ...
                              <tr><td><?php echo $con->CON_ID; ?></td>
                                  ...
                                  <td><?php echo $con->CON_TELEFONE; ?></td>
                                  ...
                                  <td>
                                      <a href="<?php echo url::base() ?>contatos/edit/<?php echo $con->CON_ID; ?>" 
                                          ...
                                          <!--<a onclick="if (window.confirm('Deseja realmente excluir o registro?')) {
                                              location.href = '<?php echo url::base() ?>contatos/excluir/<?php echo 
                                                  $con->CON_ID; ?>';
                                          }    
