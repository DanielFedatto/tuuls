    ...
    <div class="col-md-12">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input type="text" validar="texto"  class="form-control  fone" placeholder="Telefone" value="<?php if($contatos) echo $contatos["CON_TELEFONE"] ?>" id="CON_TELEFONE" name="CON_TELEFONE" onblur="verificaTelefone(this)">
            </div>
        </div>
