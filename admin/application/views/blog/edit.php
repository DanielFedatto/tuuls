<section id="formulario">
    ...
    <div class="col-md-12">
        ...
        <div class="form-group">
            <label for="BLO_DATA" class="col-sm-2 control-label">Data *</label>
            <div class="input-group">
                <div class="input-group-addon">
                    <i class="fa fa-calendar"></i>
                </div>
                <input type="text" validar="data"  class="form-control data pequeno" placeholder="Data" value="<?php if($blog) echo Controller_Index::aaaammdd_ddmmaaaa($blog["BLO_DATA"]) ?>" id="BLO_DATA" name="BLO_DATA">
            </div>
        </div>
                                        
        <div class="form-group multiplo" label="Ativo">
            <label for="BLO_ATIVO" class="col-sm-2 control-label">Ativo *</label>
            <div class="col-sm-10">
            <input type="radio" name="BLO_ATIVO" <?php if ($blog["BLO_ATIVO"] == "S") echo "checked"; ?> id="ATIVOSim" value="S" validar="radio"> Sim &nbsp;&nbsp;&nbsp;
            <!--<label for="ATIVOSim" class="col-sm-2 control-label">Sim</label>-->
            <input type="radio" name="BLO_ATIVO" <?php if ($blog["BLO_ATIVO"] == "N") echo "checked"; ?> id="ATIVONão" value="N" validar="radio"> Não &nbsp;&nbsp;&nbsp;
