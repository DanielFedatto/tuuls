<section id="lista">
    ...
    <!--INCLUIR E PESQUISA-->
    <div class="operacoes"><a href="<?php echo url::base() ?>conversaotopicos/edit" class="btn-inserir">Novo</a><form id="formBusca" name="formBusca" method="get" action="<?php echo url::base() ?>conversaotopicos/pesquisa" class="pesquisa">
                ...
                <div class="box-body">
                    <table class="table table-bordered">
                      ...
                      <tr>
                          ...
                          <th>Título
                              <span><a href="#" onclick="ordenar('COT_TITULO', 'asc')" class="seta-acima"></a>
                                  <a href="#" onclick="ordenar('COT_TITULO', 'desc')" class="seta-abaixo"></a></span>
                          </th>
                      ...
                      if (count($conversaotopicos) > 0) {
                          foreach($conversaotopicos as $cot){
                              ?>
                              <tr><td><?php echo $cot->COT_ID; ?></td>
                                  <td><?php echo $cot->COT_TITULO; ?></td>
                                  <td>
                                      <a href="<?php echo url::base() ?>conversaotopicos/edit/<?php echo $cot->COT_ID; ?>" 
                                          class="btn-app-list fa fa-edit"></a>
                                          <a onclick="if (window.confirm('Deseja realmente excluir o registro?')) {
                                              location.href = '<?php echo url::base() ?>conversaotopicos/excluir/<?php echo 
                                                  $cot->COT_ID; ?>';
                                          }    
                          ...
                          ?>
                          <tr>
                              <td colspan="3" class="naoEncontrado">Nenhum Conversão Tópicos encontrado</td>
                          </tr>
                          <?php
                      }
                      ?>
