<section id="formulario">
    ...
    <div class="col-md-12">
        <div class="box box-info">
            <form action="<?php echo url::base() ?>conversaotopicos/save" class="form-horizontal" id="formEdit" name="formEdit" method="post">
        ...
        <!--FORMULARIO COM INFORMACOES-->
                <input type="hidden" id="COT_ID" readonly name="COT_ID" value="<?php echo $conversaotopicos["COT_ID"] ?>">
    
        <div class="form-group">
            <label for="COT_TITULO" class="col-sm-2 control-label">Título *</label>
            <div class="col-sm-10">
                
                <input type="text" validar="texto"  class="form-control  " placeholder="Título" value="<?php if($conversaotopicos) echo $conversaotopicos["COT_TITULO"] ?>" id="COT_TITULO" name="COT_TITULO" >
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <textarea  class="form-control ckeditor" placeholder="Texto" id="COT_TEXTO" name="COT_TEXTO">
                    <?php if($conversaotopicos) echo $conversaotopicos["COT_TEXTO"] ?>
                </textarea>
            </div>
        </div>
