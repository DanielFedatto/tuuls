        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="<?php echo url::base(); ?>index" class="logo">
                    ...
                    <span class="logo-mini"><img src="<?php echo url::base(); ?>images/logo_tuuls.svg" style="height: 25px;"/></span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg"><img src="<?php echo url::base(); ?>images/logo_tuuls.svg" style="width: 200px;"/></span>
                </a>
